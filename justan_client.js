...
class JUSTAN extends Client {
    constructor(options) {
        super({
            ...
            presence: {
                activities: [{
                  name: conf && conf.presence.length > 0 ? conf.presence : "Justan Was Here",
                  type: ActivityType.Playing,
                  url:"https://www.twitch.tv/justanwashere"
                }],
                status: 'dnd'
              }
        })
